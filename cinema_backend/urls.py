...
from .views import GenreAPIView, MovieAPIView, HallAPIView, MovieSessionAPIView, SeatsAPIView, TicketsAPIView, ReviewAPIView
...
urlpatterns = [
    ...
    path('api/v1/reviews/<int:movie_id>/',
         ReviewAPIView.as_view(),  name='reviews'),
]
